            ...
            <div class="left side-menu">
                ...
                <div class="left-side-logo d-block d-lg-none">
                    <div class="text-center">
                        <a href="index.html" class="logo"><img src="{{asset('dashboard/assets/images/logo-dark.png') }}" height="20" alt="logo"></a>
                    </div>
                </div>
                    ...
                    <div class="topbar">
                        ...
                        <div class="topbar-left	d-none d-lg-block">
                            <div class="text-center">
                                ...
                                <a href="index.html" class="logo"><img src="{{asset('dashboard/assets/images/logo.png') }}" height="20" alt="logo"></a>
                            </div>
                        </div>
